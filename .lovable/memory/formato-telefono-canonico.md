...
REGLA DE ORO (palabras del usuario): SIEMPRE primero va el país (México = +52) y después los 10 dígitos, en todo registro, consulta, invitación o búsqueda. Sin excepciones.
