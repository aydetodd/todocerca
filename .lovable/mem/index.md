...
## Core
- **Identidad dual QaRd**: apodo en todo lo social (chats, mapa, publicaciones); nombre completo y CURP solo en pantallas de dinero.

- **Teléfono canónico**: Siempre clave país + 10 dígitos (México: +52XXXXXXXXXX). Normalizar antes de guardar o buscar.
...
- [proveedor-spei-openpay](mem://negocio/proveedor-spei-openpay) — Openpay en vez de STP (VPN); aún sin contratar
