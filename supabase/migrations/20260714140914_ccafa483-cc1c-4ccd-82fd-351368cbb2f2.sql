...
BEGIN
  ...
  -- Debitar ORIGEN: wallets.saldo_mxn = saldo de la tarjeta principal (sub_index 0), NO agregado.
  -- Los sub-QR guardan su propio saldo. Solo tocamos qard_wallets cuando el sub_index es 0.
  IF v_from_sub_index = 0 THEN
  ...
  -- Acreditar DESTINO + rotar cvv dinámico solo si NO es mismo dueño
