...
CREATE POLICY "Providers can upload product photos" 
ON storage.objects 
FOR INSERT 
WITH CHECK (
...
CREATE POLICY "Providers can update their product photos" 
ON storage.objects 
FOR UPDATE 
USING (
  bucket_id = 'product-photos' 
...
CREATE POLICY "Providers can delete their product photos" 
ON storage.objects 
FOR DELETE 
USING (
  bucket_id = 'product-photos' 
